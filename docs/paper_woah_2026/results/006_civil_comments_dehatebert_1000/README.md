# 006_civil_comments_dehatebert_1000
...
micromamba run -n icem-research python scripts/run_icem_experiment.py \
  ...
  --output-dir docs/paper_woah_2026/results/006_civil_comments_dehatebert_1000 \
  --overwrite
```
...
```text
data/outputs/006_civil_comments_dehatebert_1000/release_rows.jsonl
```
