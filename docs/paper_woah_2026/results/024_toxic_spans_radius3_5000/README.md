...
micromamba run -n icem-research python scripts/run_icem_experiment.py \
  ...
  --output-dir docs/paper_woah_2026/results/024_toxic_spans_radius3_5000 \
  --overwrite
```
...
```text
data/outputs/024_toxic_spans_radius3_5000/024_toxic_spans_radius3_5000/release_rows.jsonl
```
