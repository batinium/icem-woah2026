# 022_hatexplain_nopii_radius3_5000
...
micromamba run -n icem-research python scripts/run_icem_experiment.py \
  ...
  --output-dir docs/paper_woah_2026/results/022_hatexplain_nopii_radius3_5000 \
  --overwrite
```
...
```text
data/outputs/022_hatexplain_nopii_radius3_5000/022_hatexplain_nopii_radius3_5000/release_rows.jsonl
```
