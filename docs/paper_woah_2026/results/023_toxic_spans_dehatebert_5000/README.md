# 023_toxic_spans_dehatebert_5000
...
micromamba run -n icem-research python scripts/run_icem_experiment.py \
  ...
  --output-dir docs/paper_woah_2026/results/023_toxic_spans_dehatebert_5000 \
  --overwrite
```
...
```text
data/outputs/023_toxic_spans_dehatebert_5000/023_toxic_spans_dehatebert_5000/release_rows.jsonl
```
