...
micromamba run -n icem-research python scripts/run_icem_experiment.py \
  ...
  --output-dir docs/paper_woah_2026/results/018_hatexplain_seed41_5000 \
  --overwrite
```
...
```text
data/outputs/018_hatexplain_seed41_5000/018_hatexplain_seed41_5000/release_rows.jsonl
```
