...
micromamba run -n icem-research python scripts/run_icem_experiment.py \
  ...
  --output-dir docs/paper_woah_2026/results/017_hatexplain_seed23_5000 \
  --overwrite
```
...
```text
data/outputs/017_hatexplain_seed23_5000/017_hatexplain_seed23_5000/release_rows.jsonl
```
