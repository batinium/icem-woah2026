# 020_hatexplain_nopii_seed23_5000
...
micromamba run -n icem-research python scripts/run_icem_experiment.py \
  ...
  --output-dir docs/paper_woah_2026/results/020_hatexplain_nopii_seed23_5000 \
  --overwrite
```
...
```text
data/outputs/020_hatexplain_nopii_seed23_5000/020_hatexplain_nopii_seed23_5000/release_rows.jsonl
```
