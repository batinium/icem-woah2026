# 027_hatexplain_nopii_radius1_5000
...
micromamba run -n icem-research python scripts/run_icem_experiment.py \
  ...
  --output-dir docs/paper_woah_2026/results/027_hatexplain_nopii_radius1_5000 \
  --overwrite
```
...
```text
data/outputs/027_hatexplain_nopii_radius1_5000/release_rows.jsonl
```
