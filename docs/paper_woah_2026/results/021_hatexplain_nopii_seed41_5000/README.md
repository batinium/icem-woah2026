# 021_hatexplain_nopii_seed41_5000
...
micromamba run -n icem-research python scripts/run_icem_experiment.py \
  ...
  --output-dir docs/paper_woah_2026/results/021_hatexplain_nopii_seed41_5000 \
  --overwrite
```
...
```text
data/outputs/021_hatexplain_nopii_seed41_5000/021_hatexplain_nopii_seed41_5000/release_rows.jsonl
```
