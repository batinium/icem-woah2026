# 019_hatexplain_nopii_seed7_5000
...
micromamba run -n icem-research python scripts/run_icem_experiment.py \
  ...
  --output-dir docs/paper_woah_2026/results/019_hatexplain_nopii_seed7_5000 \
  --overwrite
```
...
```text
data/outputs/019_hatexplain_nopii_seed7_5000/019_hatexplain_nopii_seed7_5000/release_rows.jsonl
```
